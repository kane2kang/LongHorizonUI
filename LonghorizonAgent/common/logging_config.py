...
def setup_logging():
    ...
    class QAgentFormatter(logging.Formatter):
        def format(self, record):
            if type(record.name) == str and record.name.startswith('LonghorizonAgent.'):
    ...
    qagent_logger = logging.getLogger('LonghorizonAgent')
    ...
    logger = logging.getLogger('LonghorizonAgent')
